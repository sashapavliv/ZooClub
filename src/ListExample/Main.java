...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true){
            ...
            switch (sc.nextInt()){
                case 1: {zooClub.addMember();}
                break;
                case 2: {zooClub.addAnimalToMember();}
                break;
                case 3: {zooClub.deleteAnimalWihtoutMember();}
                break;
                case 4: {zooClub.deleteMember();}
                break;
                case 5: {zooClub.printAllAnimals();}
                break;
                case 6: {zooClub.printZooClub();}
                break;
